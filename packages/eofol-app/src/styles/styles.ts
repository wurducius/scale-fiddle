...
export const initStyles = () => {
  ...
  createStyle(
    `input[type="range"] { margin-top: 8px; padding: 0 0 0 0; width: 256px; height: 24px; accent-color: ${theme.color.secondary}; cursor: pointer; }`
  );
  createStyle(
  ...
  createStyle(
    `input { cursor: text; padding: 2px 10px; margin-top: 8px; margin-bottom: 8px; font-size: 16px; width: 256px; height: 24px; background-color: ${theme.color.backgroundElevation}; color: ${theme.color.secondary}; border: 1px solid ${theme.color.secondary}; }`
  );
  createStyle(`input:focus { outline: 2px solid ${theme.color.secondary}; }`);

  createStyle(
    `textarea { cursor: text; margin-right: 0; padding: 8px 0 8px 8px; font-size: 16px; width: 256px; height: 24px; background-color: ${theme.color.backgroundElevation}; color: ${theme.color.secondary}; border: 1px solid ${theme.color.secondary}; }`
  );

  createStyle(
    `select { padding: 6px 10px; margin-top: 8px; font-size: 16px; height: 36px; width: 256px; background-color: ${theme.color.background}; color: ${theme.color.secondary}; border: 1px solid ${theme.color.secondary} }`
  );
